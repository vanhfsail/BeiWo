...
public class HoveringScrollView extends ScrollView {
    ...
    /**
     * 主要是用在用户手指离开HoveringScrollView，HoveringScrollView还在继续滑动，我们用来保存Y的距离，然后做比较
     */
    ...
    public HoveringScrollView(Context context, AttributeSet attrs, int defStyle) {
     ...
     * HoveringScrollView可能还在滑动，所以当用户抬起手我们隔5毫秒给handler发送消息，在handler处理
    ...
    public interface OnScrollListener {
        /**
         * 回调方法， 返回HoveringScrollView滑动的Y方向距离
         */
